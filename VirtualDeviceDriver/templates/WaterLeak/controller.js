...
var WaterLeak = {
    start: function(options) {
        ...
        if( (options.initialState && options.initialState.state) ) {
            this._waterleak = options.initialState.state.waterleak || this._waterleak;
        }
    },
    stop: function() {
    },
    state: {
        waterleak: {
            get: function() {
                return Promise.resolve(this._waterleak);
            },
            set: function(value) {
    ...
    commands: {
        emit: function(value) {
            ...
            this._waterleak = value;
            this._logger.debug('Emitting waterleak ' + value);
            dev$.publishResourceStateChange(this._resourceID, 'waterleak', value);
            return Promise.resolve('waterleak state changed to ' + value);
        },
...
module.exports = dev$.resource('Core/Devices/Virtual/WaterLeak', WaterLeak);
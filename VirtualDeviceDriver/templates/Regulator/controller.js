...
var Regulator = {
    start: function(options) {
        ...
        if( (options.initialState && options.initialState.state) ) {
            this._regulator = options.initialState.state.regulator || this._regulator;
        }
    ...
    state: {
        regulator: {
            ...
            set: function(value) {
                this._logger.debug('Got regulator ' + value);
    ...
    commands: {
        emit: function(value) {
            ...
            this._regulator = value;
            this._logger.debug('Emitting regulator ' + value);
            dev$.publishResourceStateChange(this._resourceID, 'regulator', value);
            return Promise.resolve('regulator state changed to ' + value);
        },
...
module.exports = dev$.resource('Core/Devices/Virtual/Regulator', Regulator);
...
var ContactSensor = {
    start: function(options) {
        ...
        if( (options.initialState && options.initialState.state) ) {
            this._states.contact = options.initialState.state.contact || this._states.contact;
    ...
    state: {
        contact: {
            get: function() {
                return Promise.resolve(this._states.contact);
            },
            set: function(value) {
    ...
    commands: {
        emit: function(value) {
            ...
            this._states.contact = value;
            this._logger.debug('Emitting contact ' + value);
            dev$.publishResourceStateChange(this._resourceID, 'contact', value);
            ...
            return Promise.resolve('Contact state changed to ' + JSON.stringify(this._states));
        },
...
module.exports = dev$.resource('Core/Devices/Virtual/ContactSensor', ContactSensor);
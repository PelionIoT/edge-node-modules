...
var OSRAM_LIGHTIFY_RT_Tunable_White = {
    start: function(options) {
        var self = this;
        self.logger = new Logger( {moduleName: 'OSRAM_LIGHTIFY_RT_Tunable_White' + options.nodeId, color: 'blue'} );
...
module.exports = dev$.resource("Core/Devices/Lighting/ZigbeeHA/OSRAM_LIGHTIFY_RT_Tunable_White", OSRAM_LIGHTIFY_RT_Tunable_White);
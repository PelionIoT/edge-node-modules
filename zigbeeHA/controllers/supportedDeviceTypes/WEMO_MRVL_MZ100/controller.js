...
var WEMO_MRVL_MZ100 = {
    start: function(options) {
        var self = this;
        this.logger = new Logger( {moduleName: 'WEMO_MRVL_MZ100' + options.nodeId, color: 'blue'} );
...
module.exports = dev$.resource("Core/Devices/Lighting/ZigbeeHA/WEMO_MRVL_MZ100", WEMO_MRVL_MZ100);
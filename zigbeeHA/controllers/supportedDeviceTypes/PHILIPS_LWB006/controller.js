...
var Philips_LWB006 = {
    start: function(options) {
        var self = this;
        self.logger = new Logger( {moduleName: 'Philips_LWB006' + options.nodeId, color: 'blue'} );
        self.logger.info('starting controller');

        //options.endPoint = 0x02;
...
module.exports = dev$.resource("Core/Devices/Lighting/ZigbeeHA/Philips_LWB006", Philips_LWB006);
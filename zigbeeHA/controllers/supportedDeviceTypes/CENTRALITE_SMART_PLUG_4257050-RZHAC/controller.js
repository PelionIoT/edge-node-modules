...
var CentraLite_4257050_RZHAC = {
    start: function(options) {
        var self = this;
        this.logger = new Logger( {moduleName: 'CentraLite_4257050_RZHAC' + options.nodeId, color: 'blue'} );
...
module.exports = dev$.resource("Core/Devices/Lighting/ZigbeeHA/CentraLite_4257050_RZHAC", CentraLite_4257050_RZHAC);
...
var GE_Appliances_ZLL_Light = {
    start: function(options) {
        var self = this;
        self.logger = new Logger( {moduleName: 'GE_Appliances_ZLL_Light' + options.nodeId, color: 'blue'} );
...
module.exports = dev$.resource("Core/Devices/Lighting/ZigbeeHA/GE_Appliances_ZLL_Light", GE_Appliances_ZLL_Light);
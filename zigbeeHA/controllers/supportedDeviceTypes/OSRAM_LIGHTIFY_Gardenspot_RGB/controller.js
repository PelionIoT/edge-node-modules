...
var OSRAM_LIGHTIFY_Gardenspot_RGB = {
    start: function(options) {
        var self = this;
        self.logger = new Logger( {moduleName: 'OSRAM_LIGHTIFY_Gardenspot_RGB' + options.nodeId, color: 'blue'} );
...
module.exports = dev$.resource("Core/Devices/Lighting/ZigbeeHA/OSRAM_LIGHTIFY_Gardenspot_RGB", OSRAM_LIGHTIFY_Gardenspot_RGB);
...
var Quirky_Smart_Switch = {
    start: function(options) {
        var self = this;
        self.logger = new Logger( {moduleName: 'Quirky_Smart_Switch' + options.nodeId, color: 'blue'} );
...
module.exports = dev$.resource("Core/Devices/Lighting/ZigbeeHA/Quirky_Smart_Switch", Quirky_Smart_Switch);
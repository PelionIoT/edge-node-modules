...
// New device joined the Trust Center.
// NwkAddr: 0x35FC
...
//                 InClusterList[1]: 0x0003 - identify
//                 InClusterList[2]: 0x0201 - thermostat
//                 InClusterList[3]: 0x0202 - fan control
//                 InClusterList[4]: 0x0204 - thermostat user interface config
//                 InClusterList[5]: 0x0402 - temperature measurement
//                 InClusterList[6]: 0x0405 - relative humidity measurement
//                 InClusterList[7]: 0x0406 - occupancy sensing
//         NumOutClusters: 0

// Device joined network:
// 0       0x35FC  0x0A    0x0301


var Viconics_254_10 = {
    start: function(options) {
        var self = this;
        self.logger = new Logger( {moduleName: 'Viconics_254_10' + options.nodeId, color: 'bgGreen'} );
    ...
    getState: function() {
        ...
        // //Note: Removing auto as it results in cancelling cooltemperature request because we already called cool before
    ...
    commands: {
        ...
        getHumidity: function(attrId) {
            return this.cluster_classes['relative_humidity'].get(attrId);
        },
        ...
        setAttribute: function(clusterClassId, attrId, type, value) {
            var self = this;
            return self.znpController.formatWriteAttrData(value, type).then(function(formattedData) {
                return self.cluster_classes[clusterClassId].setAttr(attrId, type, formattedData);
            });
        },
        configureReport: function(report) {
            
        }
    }
};

module.exports = dev$.resource("Core/Devices/Lighting/ZigbeeHA/Viconics_254_10", Viconics_254_10);
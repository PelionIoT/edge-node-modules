...
var OSRAM_LIGHTIFY_A19_ON_OFF_DIM = {
    start: function(options) {
        var self = this;
        self.logger = new Logger( {moduleName: 'OSRAM_LIGHTIFY_A19_ON_OFF_DIM' + options.nodeId, color: 'blue'} );
...
module.exports = dev$.resource("Core/Devices/Lighting/ZigbeeHA/OSRAM_LIGHTIFY_A19_ON_OFF_DIM", OSRAM_LIGHTIFY_A19_ON_OFF_DIM);